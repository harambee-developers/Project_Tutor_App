    ...
    const fetchAvailability = async () => {
      try {
        ...
        const availabilityData = response.data?.[0]?.days
          ...
          : [];
        console.log("Response: ", response.data?.[0]?.days); // Using optional chaining for safe access
    ...
    <div className="container mx-auto px-4 min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden px-4">
          <h1 className="font-semibold text-xl py-4 border-b">
          ...
          <div className="px-4 py-6 space-y-4">
            <button
              className="mt-20 bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 w-full rounded-md transition duration-300 ease-in-out"
          ...
          <ChatModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
            ...
            />
            <button
              className="mt-4 bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 w-full rounded-md transition duration-300 ease-in-out"
              onClick={sendMessage}
            >
              Send
            </button>
