  ...
  return (
    <nav className="shadow-md w-full top-0 bg-gray-200">
      <div className="md:flex items-center justify-between text-white mr-6 text-xl md:px-10 px-7">
        ...
        <button className="absolute right-10 top-7 cursor-pointer md:hidden mt-5 text-gray-800" onClick={toggleMenu}>
          ...
          <ul className="md:flex md:items-center md:space-x-4 md:space-y-0 space-y-4 text-base">
            {authUser ? (
              <>
                ...
                <li><button onClick={handleLogout} className="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Logout</button></li>
